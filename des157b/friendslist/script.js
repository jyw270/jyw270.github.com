...
(function () {
  ...
  async function setForm(recordId) {
    ...
    try {
      ...
      results.forEach(function (thisFriend) {
        ...
        document.getElementById("fbook-edit").value =
          thisFriend.get("facebook");
        document.getElementById("twitter-edit").value =
          thisFriend.get("twitter");
        document.getElementById("insta-edit").value =
          thisFriend.get("instagram");
        document.getElementById("linkedin-edit").value =
          thisFriend.get("linkedin");
      });
  ...
  async function updateRecord(recordId) {
    const theFields = document.querySelectorAll(
      "#edit-friend input:not([type=submit])"
    );
    const editedRecord = {};
    let key;
    let value;
    ...
    try {
      ...
      console.error("Error while rettrieving object friends", error);
    }
  }
